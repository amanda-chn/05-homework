{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "avg_wealth = df.groupby(by=\"gender\").networthusbillion.mean()\n",
    "avg_wealth"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "wealth_type = df.groupby(by=\"gender\").typeofwealth.value_counts()\n",
    "wealth_type"
   ]
  },
  {
  ...
  },
  {
   ...
   "outputs": [
    ...
    {
     "data": {
      "image/png": "",
      "text/plain": [
  ...
  },
  {
   ...
   "source": [
    "youngest = df.sort_values(by=\"age\").head(10)\n",
    "youngest"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "df.plot.scatter(x=\"age\", y=\"networthusbillion\", s=None, c=None)"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [
    ...
    {
     "data": {
      "image/png": "",
      "text/plain": [
       "<Figure size 432x288 with 1 Axes>"
      ]
     },
